		...
		<div class="container">
			...
			<div class="row">
				<div class="col text-center">
					<h3
						class="text-uppercase font-weight-bold display-4 text-light banner-heading">
						</h3>
					<h3 class="display-4 text-light banner-heading pt-3 pb-4">Welcome To Flyaway
						</h3>
					<a href="bookflight.jsp"
						class="btn btn-outline-primary text-uppercase px-7">
	...
	<footer>
		<div class="row justify-content-center">
			<div class="col-md-5 text-center">
				...
				<p>
					<i class="fas fa-phone-square pr-2 fa-2x text-success"></i>{8871}
					435-408
				</p>
				<p>
					<i class="fas fa-envelope-open-text pr-2 fa-2x text-success"></i>Rahul94kumar02@flyaway.com
				</p>
